        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 col-12 mb-2">
              <h4 className="mb-3">
                Satisfy your cravings at Crispy Kitchen - where every bite is a
                crispy, delicious adventure!
              </h4>
            ...
            <div className="col-lg-6 col-12">
              <p>
                ...
                Voluptate eaque iure quod in iste sunt molestiae consequatur
                quis culpa facilis omnis perspiciatis ab magnam nam
                reprehenderit autem provident, commodi fugiat. Please{" "}
              ...
              <p>
                Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                Placeat vero sit repellendus amet autem dolorum aliquam
                cupiditate rem asperiores et doloribus, suscipit numquam iste
                saepe totam blanditiis cum molestiae adipisci. Nulla quisquam
                doloremque similique doloribus a iure perspiciatis quasi itaque.
              </p>
            </div>
          </div>
        </div>
