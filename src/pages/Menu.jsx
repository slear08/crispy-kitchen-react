        ...
        <section className="menu section-padding">
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-4 col-md-6 col-12">
                        <div className="menu-thumb">
                            <img src={image.breakfast3} className="img-fluid menu-image" alt=""/ >
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-6 col-12">
                        <div className="menu-thumb">
                            <img src={image.lunch4} className="img-fluid menu-image" alt=""/>
                    ...
                    <div className="col-lg-6 col-12">
                        <div className="menu-thumb">
                            <img src={image.lunch3} className="img-fluid menu-image" alt=""/>
        ...
        <section className="menu section-padding">
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-4 col-md-6 col-12">
                        <div className="menu-thumb">
                            <img src={image.dinner1} className="img-fluid menu-image" alt=""/>
